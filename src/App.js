...
showPending = () =>{
  ...
  openHelp = (object, num) =>{
    this.setState({help:true, selectedImage: object, activeDriver: num})
  }
  hideHelp = () =>{
...
render(){
  const pending = this.state.months.map((data, index) =>
  <div>
      <div className="card2" key={data} onClick={ () => this.openHelp(this.state.images[index], index)}>
      ...
      <div className={this.state.menu ? "App-header" : "Transition"}>
        ...
        {/* <div className={this.state.help ? "App-modal" : "App-hide"}>
          ...
          <span className="App-close" onClick={this.hideHelp}>&times;</span><br></br>
            ...
            <p className="App-Details2">
            <span><a ></a> <a className="contentIcons">Name: joaquin phoenix</a></span>
            <br></br>
            <span ><a ></a><a className="contentIcons">Deliveries: 30</a>  </span>
           <br></br>
            <span ><a ></a><a className="contentIcons">Age: 25 Years</a></span>
           <br></br>
           <span><a ></a><a className="contentIcons">Cell: 081 765 3395 </a> </span>
           <br></br>
           <span><a ></a><a className="contentIcons">Email: myemail@gmail.com</a></span>
           <br></br>
           <span><a></a><a className="contentIcons">Mode: Bakkie</a></span>
           <br></br>
           <span><a ></a><a className="contentIcons">Plate Number: CTT 125 GP</a></span>
           <br></br>
            </p>
          </div>
        </div> */}
